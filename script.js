...
// Basic pastel image presets for each category (CSS gradients used as "images")
const IMAGE_PRESETS = {
  "Ice Cream Bars":
    "linear-gradient(135deg, #fed7e2, #f97316), url('https://images.pexels.com/photos/1352278/pexels-photo-1352278.jpeg?auto=compress&cs=tinysrgb&w=600')",
  "Ice Cream Cups":
    "linear-gradient(135deg, #bfdbfe, #e0f2fe), url('https://images.pexels.com/photos/1183600/pexels-photo-1183600.jpeg?auto=compress&cs=tinysrgb&w=600')",
  "Premium Cups":
    "linear-gradient(135deg, #fef3c7, #f9a8d4), url('https://images.pexels.com/photos/4051525/pexels-photo-4051525.jpeg?auto=compress&cs=tinysrgb&w=600')",
  "Cone Ice Cream":
    "linear-gradient(135deg, #fecaca, #fed7aa), url('https://images.pexels.com/photos/1379395/pexels-photo-1379395.jpeg?auto=compress&cs=tinysrgb&w=600')",
  "Milk Lolly":
    "linear-gradient(135deg, #c4b5fd, #f5d0fe), url('https://images.pexels.com/photos/4109992/pexels-photo-4109992.jpeg?auto=compress&cs=tinysrgb&w=600')",
  Juices:
    "linear-gradient(135deg, #bbf7d0, #a5f3fc), url('https://images.pexels.com/photos/96974/pexels-photo-96974.jpeg?auto=compress&cs=tinysrgb&w=600')",
};
...
function createMenuItemElement(item, categoryName) {
  ...
  const preset = IMAGE_PRESETS[categoryName] || IMAGE_PRESETS.Juices;
  image.style.backgroundImage = preset;

  const imageLabel = document.createElement("span");
  imageLabel.textContent = "Tap to add";
